    ...
    return <div className="px-9">
        ...
        <div className="mt-6">
            <div className="shadow-2xl shadow-neutral-400 rounded-2xl bg-neutral-50">
                <div ref={tableRef} className="overflow-y-auto h-[39rem] rounded-2xl scrollbar-hide" style={{
                    scrollbarWidth: 'none',
                    ...
                    <table className="relative w-full border border-neutral-300 text-sm text-neutral-700">
                        ...
                        <tbody>
                            {filteredCampaigns.map((campaign, index) => (
                                <tr key={`${campaign.id}-${index}`} className="hover:bg-gray-200/60 hover:cursor-pointer">
